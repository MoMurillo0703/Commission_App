...
| SHA | `5e74bacfb25e19afcda2257f34aaf2697f6e53a8` |
| Deployed | 2026-09-14 |
| Migrations | **0001–0011** (no new migration for this application deploy) |
| Agency owner | Mo / `agents.id = 2`, effective **2026-09 → Present**. August owner absence is a separate Product Owner decision; do not backdate. |
| Release state | **DEPLOYED — PRODUCT ACCEPTANCE IN PROGRESS** |
| Product acceptance | Compensation Workspace is live for Mo retest after acceptance corrections. Do not mark Product Accepted or Done yet. Do not post Statement 7, create/backdate August Agency owner, create Joses production compensation, run historical Anthem correction, or rewrite production financial records as a deploy test. |
...
- Person-centric bulk Compensation workspace: one Group + LOB directory (legacy Browse-by-Group editor removed from the normal Compensation page); Select all matching / Deselect all across pagination; template or custom people split; accepted Preview; Commit gated behind valid Preview. Owner warning follows the selected Effective month. Monthly Compensation Audit lives on Reports with business-facing copy. Canonical allocation conflict remains Review Required.
